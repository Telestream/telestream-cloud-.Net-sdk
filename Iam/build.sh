...
${nuget_cmd} install src/Telestream.Cloud.Iam/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Telestream.Cloud.Iam.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/Telestream.Cloud.Iam.dll \
-recurse:'src/Telestream.Cloud.Iam/*.cs' \
-doc:bin/Telestream.Cloud.Iam.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/Telestream.Cloud.Iam.dll was created successfully"
fi
