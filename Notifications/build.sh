...
${nuget_cmd} install src/Telestream.Cloud.Notifications/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Telestream.Cloud.Notifications.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/Telestream.Cloud.Notifications.dll \
-recurse:'src/Telestream.Cloud.Notifications/*.cs' \
-doc:bin/Telestream.Cloud.Notifications.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/Telestream.Cloud.Notifications.dll was created successfully"
fi
