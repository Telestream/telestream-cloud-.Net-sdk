...
namespace Telestream.Cloud.Notifications.Api
{
    ...
    public partial class NotificationsApi : INotificationsApi
    {
        ...
        {
             ApiResponse<List<Subscription>> localVarResponse = ListSubscriptionsWithHttpInfo();
        ...
        /// <exception cref="Telestream.Cloud.Notifications.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of List&lt;Subscription&gt;</returns>
        public ApiResponse< List<Subscription> > ListSubscriptionsWithHttpInfo ()
        {
        ...
        /// <exception cref="Telestream.Cloud.Notifications.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of List&lt;Subscription&gt;</returns>
        public async System.Threading.Tasks.Task<List<Subscription>> ListSubscriptionsAsync ()
        {
             ApiResponse<List<Subscription>> localVarResponse = await ListSubscriptionsAsyncWithHttpInfo();
             return localVarResponse.Data;
        ...
        /// <exception cref="Telestream.Cloud.Notifications.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (List&lt;Subscription&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<Subscription>>> ListSubscriptionsAsyncWithHttpInfo ()
        {
