...
namespace Telestream.Cloud.Notifications.Client
{
    ...
    public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            Configuration = Telestream.Cloud.Notifications.Client.Configuration.Default;
            RestClient = new RestClient("https://api.cloud.telestream.net/notifications/v1.0");
            RestClient.IgnoreResponseStatusCode = true;
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (https://api.cloud.telestream.net/notifications/v1.0).
        /// </summary>
        /// <param name="config">An instance of Configuration.</param>
        public ApiClient(Configuration config)
        {
            Configuration = config ?? Telestream.Cloud.Notifications.Client.Configuration.Default;
        ...
        public ApiClient(String basePath = "https://api.cloud.telestream.net/notifications/v1.0")
        {
