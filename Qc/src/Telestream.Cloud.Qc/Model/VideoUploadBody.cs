...
namespace Telestream.Cloud.Qc.Model
{
    ...
    public partial class VideoUploadBody :  IEquatable<VideoUploadBody>
    {
        ...
        public VideoUploadBody(long? FileSize = default(long?), string FileName = default(string), List<ExtraFile> ExtraFiles = default(List<ExtraFile>), string Profiles = default(string), bool? MultiChunk = true)
        {
