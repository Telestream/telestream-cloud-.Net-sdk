...
namespace Telestream.Cloud.Qc.Model
{
    ...
    public partial class VideoStream :  IEquatable<VideoStream>
    {
        ...
        public VideoStream(decimal? Duration = default(decimal?), string Codec = default(string), int? Width = default(int?), int? Height = default(int?), int? Bitrate = default(int?), decimal? Fps = default(decimal?))
        {
