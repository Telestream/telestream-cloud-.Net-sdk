...
namespace Telestream.Cloud.Qc.Model
{
    ...
    public partial class Project :  IEquatable<Project>
    {
        ...
        public Project(string Id = default(string), string Name = default(string), StatusEnum? Status = default(StatusEnum?), string Template = default(string), string Options = default(string))
        {
            this.Id = Id;
            this.Name = Name;
            this.Status = Status;
