...
namespace Telestream.Cloud.Qc.Model
{
    ...
    public partial class Alert :  IEquatable<Alert>
    {
        ...
        public Alert(string Level = default(string), string Info = default(string), decimal? Begin = default(decimal?), decimal? End = default(decimal?), int? Stream = default(int?), string Detail = default(string))
        {
            this.Level = Level;
            this.Info = Info;
            this.Begin = Begin;
