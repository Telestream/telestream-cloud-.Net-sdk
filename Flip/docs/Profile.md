...
**BufferSize** | **int?** | Determines the size of the PulseAudio buffer. by default it is not set. | [optional] 
...
**CropInputWidth** | **decimal?** | Height of the cropped image in pixels. | [optional] 
