...
${nuget_cmd} install src/Telestream.Cloud.Flip/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Telestream.Cloud.Flip.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/Telestream.Cloud.Flip.dll \
-recurse:'src/Telestream.Cloud.Flip/*.cs' \
-doc:bin/Telestream.Cloud.Flip.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/Telestream.Cloud.Flip.dll was created successfully"
fi
