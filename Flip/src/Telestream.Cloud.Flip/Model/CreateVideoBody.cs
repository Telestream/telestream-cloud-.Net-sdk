...
namespace Telestream.Cloud.Flip.Model
{
    ...
    public partial class CreateVideoBody :  IEquatable<CreateVideoBody>
    {
        ...
        public CreateVideoBody(string SourceUrl = default(string), string Profiles = default(string), string Payload = default(string), string Pipeline = default(string), List<string> SubtitleFiles = default(List<string>))
        {
