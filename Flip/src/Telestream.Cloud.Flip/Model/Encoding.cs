...
namespace Telestream.Cloud.Flip.Model
{
    ...
    public partial class Encoding :  IEquatable<Encoding>
    {
        ...
        public Encoding(string Id = default(string), int? AudioBitrate = default(int?), int? AudioChannels = default(int?), string AudioCodec = default(string), string AudioSampleRate = default(string), string CreatedAt = default(string), string Duration = default(string), string EncodingProgress = default(string), string EncodingTime = default(string), string ErrorClass = default(string), string ErrorMessage = default(string), string ExternalId = default(string), string Extname = default(string), string FileSize = default(string), List<string> Files = default(List<string>), string Fps = default(string), string Height = default(string), string Width = default(string), string LogfileUrl = default(string), string MimeType = default(string), string ParentEncodingId = default(string), string Path = default(string), string ProfileId = default(string), string ProfileName = default(string), List<string> Screenshots = default(List<string>), string StartedEncodingAt = default(string), string Status = default(string), string UpdatedAt = default(string), string VideoBitrate = default(string), string VideoCodec = default(string), string VideoId = default(string))
        {
            this.Id = Id;
