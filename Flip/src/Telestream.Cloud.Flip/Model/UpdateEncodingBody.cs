...
namespace Telestream.Cloud.Flip.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateEncodingBody :  IEquatable<UpdateEncodingBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateEncodingBody" /> class.
        /// </summary>
        ...
        public UpdateEncodingBody(string ProfileId = default(string), string ProfileName = default(string))
        {
        ...
        {
            return this.Equals(input as UpdateEncodingBody);
        }

        /// <summary>
        /// Returns true if UpdateEncodingBody instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateEncodingBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateEncodingBody input)
        {
            if (input == null)
                return false;
