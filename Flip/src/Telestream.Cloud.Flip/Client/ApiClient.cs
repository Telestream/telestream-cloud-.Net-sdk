...
namespace Telestream.Cloud.Flip.Client
{
    ...
    public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            ...
            RestClient = new RestClient("https://api.cloud.telestream.net/flip/3.1");
            RestClient.IgnoreResponseStatusCode = true;
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (https://api.cloud.telestream.net/flip/3.1).
        /// </summary>
        ...
        public ApiClient(String basePath = "https://api.cloud.telestream.net/flip/3.1")
        {
