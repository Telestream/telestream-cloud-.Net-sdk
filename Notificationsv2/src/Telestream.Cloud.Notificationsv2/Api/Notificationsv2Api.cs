...
namespace Telestream.Cloud.Notificationsv2.Api
{
    /// <summary>
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface INotificationsv2Api : IApiAccessor
    {
        ...
        /// 
        /// </remarks>
        /// <exception cref="Telestream.Cloud.Notificationsv2.Client.ApiException">Thrown when fails to make API call</exception>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class Notificationsv2Api : INotificationsv2Api
    {
        private Telestream.Cloud.Notificationsv2.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="Notificationsv2Api"/> class.
        /// </summary>
        /// <returns></returns>
        public Notificationsv2Api(String basePath)
        {
            this.Configuration = new Configuration { BasePath = basePath };

            ExceptionFactory = Telestream.Cloud.Notificationsv2.Client.Configuration.DefaultExceptionFactory;
        }
        ...
        /// <returns></returns>
        public Notificationsv2Api(Configuration configuration = null)
        {
        ...
        /// </summary>
        public Telestream.Cloud.Notificationsv2.Client.ExceptionFactory ExceptionFactory
        {
            get
            {
        ...
        public ApiResponse<Object> DeleteSubscriptionWithHttpInfo (string id)
        {
            ...
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Notificationsv2Api->DeleteSubscription");
        ...
        public ApiResponse< Subscription > GetSubscriptionWithHttpInfo (string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Notificationsv2Api->GetSubscription");
        ...
        public ApiResponse< Subscription > ModifySubscriptionWithHttpInfo (string id, UpdateData updateData = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Notificationsv2Api->ModifySubscription");
