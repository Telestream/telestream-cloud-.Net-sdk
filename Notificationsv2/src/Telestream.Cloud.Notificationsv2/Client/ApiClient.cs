...
namespace Telestream.Cloud.Notificationsv2.Client
{
    /// <summary>
    ...
    public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            Configuration = Telestream.Cloud.Notificationsv2.Client.Configuration.Default;
            RestClient = new RestClient("https://api.cloud.telestream.net/notifications/v2.0");
            RestClient.IgnoreResponseStatusCode = true;
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (https://api.cloud.telestream.net/notifications/v2.0).
        /// </summary>
        /// <param name="config">An instance of Configuration.</param>
        public ApiClient(Configuration config)
        {
            Configuration = config ?? Telestream.Cloud.Notificationsv2.Client.Configuration.Default;
        ...
        public ApiClient(String basePath = "https://api.cloud.telestream.net/notifications/v2.0")
        {
