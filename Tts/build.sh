...
${nuget_cmd} install src/Telestream.Cloud.Tts/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Telestream.Cloud.Tts.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/Telestream.Cloud.Tts.dll \
-recurse:'src/Telestream.Cloud.Tts/*.cs' \
-doc:bin/Telestream.Cloud.Tts.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/Telestream.Cloud.Tts.dll was created successfully"
fi
