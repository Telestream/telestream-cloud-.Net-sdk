...
${nuget_cmd} install src/Telestream.Cloud.Stores/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Telestream.Cloud.Stores.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/Telestream.Cloud.Stores.dll \
-recurse:'src/Telestream.Cloud.Stores/*.cs' \
-doc:bin/Telestream.Cloud.Stores.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/Telestream.Cloud.Stores.dll was created successfully"
fi
