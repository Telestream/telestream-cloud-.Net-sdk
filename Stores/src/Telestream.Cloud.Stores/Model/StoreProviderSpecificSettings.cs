...
{
    /// <summary>
    /// StoreProviderSpecificSettings
    /// </summary>
    [DataContract]
    public partial class StoreProviderSpecificSettings :  IEquatable<StoreProviderSpecificSettings>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StoreProviderSpecificSettings" /> class.
        /// </summary>
        ...
        public StoreProviderSpecificSettings(string Host = default(string), string Port = default(string), string CacheControl = default(string), string Metadata = default(string), string FaspPort = default(string), string SshPort = default(string), string MaxRate = default(string), string MinRate = default(string), string Policy = default(string))
        {
            this.Host = Host;
            this.Port = Port;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StoreProviderSpecificSettings {\n");
        ...
        {
            return this.Equals(input as StoreProviderSpecificSettings);
        }

        /// <summary>
        /// Returns true if StoreProviderSpecificSettings instances are equal
        /// </summary>
        /// <param name="input">Instance of StoreProviderSpecificSettings to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StoreProviderSpecificSettings input)
        {
            if (input == null)
                return false;
